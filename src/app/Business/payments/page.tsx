...
export default function BusinessPaymentsPage() {
  ...
  const vendorOrders =
    orders?.filter((o) => o.vendorId === form.vendorId) ?? [];
  ...
  function handleSubmit() {
    ...
    create.mutate({
      ...
      method: form.method,
      orderId:
        form.orderId && form.orderId !== "none" ? form.orderId : undefined,
  ...
  return (
    <div className="w-full space-y-6">
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <div className="space-y-4 py-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <Select
                    value={form.method}
                    onValueChange={(v) =>
                      setForm((p) => ({ ...p, method: v as FormMethod }))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
              ...
              <div className="rounded-lg border border-black/[0.06] bg-[#f8f7f4] px-3 py-2 text-xs text-muted-foreground">
                ...
                <span
                  className={`font-semibold ${INSTANT_METHODS.includes(form.method) ? "text-green-600" : "text-yellow-600"}`}
                >
          ...
          <div className="space-y-4 py-2">
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setEditForm((p) => ({
                    ...p,
                    status: v as typeof editForm.status,
                  }))
                }
              >
                <SelectTrigger>
            ...
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setEditForm((p) => ({ ...p, method: v as FormMethod }))
                }
              >
                <SelectTrigger>
                  <SelectValue />
      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
          {filtered.map((p) => {
            console.log(p.invoiceFile?.length); // ✅ ADD THIS
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        <p className="font-semibold text-[#1a1a2e]">
                          {p.invoiceRef ??
                            `PAY-${p.id.slice(0, 6).toUpperCase()}`}
                        </p>
                        <Badge
                          className={`border-0 capitalize ${STATUS_COLORS[p.status] ?? ""}`}
                        >
                          {p.status}
                        </Badge>
                      </div>
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              This payment will be soft-deleted and kept in
                              history.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
